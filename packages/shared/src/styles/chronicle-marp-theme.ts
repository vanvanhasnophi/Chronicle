...
/** Generate Chronicle light theme CSS.
 *  @param accent    Hex color, default '#2563eb'
 *  @param tintedBg  Tinted background mode
 */
export function chronicleLightCSS(accent = '#2563eb', tintedBg = false): string {
...
section {
  font-family: "InterVariable","Inter",-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif;
  font-size: 28px; line-height: 1.6; color: #111; background: ${bg};
  padding: 60px 80px; width: 1280px; height: 720px;
}
...
section pre code { background: none; padding: 0; font-size: .9em; line-height: 1; }
...
section table th {
  background: ${cardBg}; color: ${cardFg}; border: 1px solid ${cardBorder};
  font-weight: bold; font-variation-settings: 'wght' 600;
}
section table td { border: 1px solid #1119; }
section blockquote {
  border-left: 4px solid ${accent}; color: #444;
  padding: 0 0 0 24px; margin: 8px 0;
}
...
.hljs-attr    { color: #795e26; } .hljs-params { color: #001080; }
.hljs-variable { color: #0b5394; } .hljs-subst { color: #0b5394; }
...
section.invert code { background: #161616; }
section.invert pre  { background: #080808; border-color: #1a1a1a; }
section.invert blockquote { color: #bbb; }
section.invert li::marker { color: #eeea; }
...
/** Generate Chronicle dark theme CSS.
 *  @param accent    Hex color, default '#58a6ff'
 *  @param tintedBg  Tinted background mode
 */
export function chronicleDarkCSS(accent = '#58a6ff', tintedBg = false): string {
...
section {
  font-family: "InterVariable","Inter",-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif;
  font-size: 28px; line-height: 1.6; color: #eee; background: ${bg};
  padding: 60px 80px; width: 1280px; height: 720px;
}
section h1 { color: ${accent}; margin-bottom: .2em; }
section h2 { font-size: 1.4em; margin: .3em 0; }
...
section blockquote {
  border-left: 4px solid ${accent}; color: #bbb;
  padding: 0 0 0 24px; margin: 8px 0;
}
section blockquote p { margin: 10px 0; }
...
section.invert h1 { color: ${accent}; } section.invert a { color: ${accent}; }
section.invert code { background: #f0f0f0; }
section.invert pre  { background: #f5f5f5; border-color: #eee; }
section.invert blockquote { color: #444; }
section.invert li::marker { color: #111a; }
...
export const chronicleCSS = chronicleLightCSS()
export const chronicleDarkCSSStr = chronicleDarkCSS()
